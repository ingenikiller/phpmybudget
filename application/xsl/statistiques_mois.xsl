                            ...
                            <tr class="cumul" fluxid="{$fluxId}">
                                ...
                                <xsl:for-each select="/root/data/ListeMois/Dynamic">
                                    ...
                                    <xsl:variable name="valeur"
                                                  select="/root/data/ListeFlux/Dynamic[fluxId=$fluxId]/associatedObjet/ListeFluxFils/Dynamic[fluxId=$fluxFils]/associatedObjet/MontantFluxFils/Dynamic[date=$mois]/total"/>
                                    <td class="montant">
                                        <xsl:if test="$valeur!=''">
