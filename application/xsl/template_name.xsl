                                ...
                                <div class="col-lg-12">
									...
									<xsl:choose>
										<xsl:when test="/root/data/Comptes/comptepro='1'">
                                            <div class="form-group row">   
                                                <xsl:call-template name="ChampMontantHoryzontal">
                                                    <xsl:with-param name="nomChamp" select="'montanttva'"/>
                                                    <xsl:with-param name="libelle" select="$LBL.MONTANTTVA"/>
                                                    <xsl:with-param name="obligatoire" select="'O'"/>
                                                    <xsl:with-param name="tabindex" select="'70'"/>
                                                </xsl:call-template>
                                            </div>
										</xsl:when>
										<xsl:otherwise>
											<input size="7" name="montanttva" id="montanttva" type="hidden" tabindex="70"/>
										</xsl:otherwise>
									</xsl:choose>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-check-input" type="checkbox" size="7" name="noncomptabilisee" id="noncomptabilisee" tabindex="80"/>
                                        </div>
                                    </div>
