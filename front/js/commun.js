...
/* Supprime les espaces de d�but d'une chaine de caract�res */
function ltrim (s)
{
	s2 = s;
	if (s2.match(/^ +/))
...
/* Supprime les espaces de fin d'une chaine de caract�res */
function rtrim (s)
{
  s2 = s;
  if (s2)
...
/* Supprime les espace de d�but et de fin de chaine */
function trim (s)
{
...
/*********************************************************
 fonction g�rant la navigation vers une page
...
/*********************************************************
 fonction g�rant le passage de page en page
	- form: formulaire de recherche
